...
SPECIES_WITH_DETECTORS = (
    ...
    'balaenoptera_physalus+fin_dorsal',
    'chelonioidea',
    'chelonioidea+head',
    'chelonia_mydas',
    'chelonia_mydas+head',
...
SPECIES_MAPPING = {
    ...
    'lynx': ('LYNX', 'Lynx'),
    'manta_alfredi': (None, 'mobula_alfredi'),
    'manta_birostris': (None, 'mobula_birostris'),
    'mobula_alfredi': ('MRR', 'Manta Ray (Reef)'),
    'mobula_birostris': ('MRG', 'Manta Ray (Giant)'),
    'manta_ray_giant': (None, 'mobula_birostris'),
    ...
    'turtle_green': ('ST-G', 'Sea Turtle (Green)'),
    'turtle_hawksbill': ('ST-HB', 'Sea Turtle (Hawksbill)'),
    'turtle_oliveridley': ('ST-OR', 'Sea Turtle (Olive Ridley)'),
    'turtle_asian': ('ST-A', 'Sea Turtle (Asian)'),
    'train': ('TRAIN', 'Train'),
    'truck': ('TRUCK', 'Truck'),
