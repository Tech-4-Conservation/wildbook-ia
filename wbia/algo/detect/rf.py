...
VERBOSE_SVM = ut.get_argflag('--verbrf') or ut.VERBOSE


CONFIG_URL_DICT = {
    # 'localizer-zebra-10'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.10.zip',
    # 'localizer-zebra-20'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.20.zip',
    # 'localizer-zebra-30'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.30.zip',
    # 'localizer-zebra-40'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.40.zip',
    # 'localizer-zebra-50'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.50.zip',
    # 'localizer-zebra-60'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.60.zip',
    # 'localizer-zebra-70'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.70.zip',
    # 'localizer-zebra-80'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.80.zip',
    # 'localizer-zebra-90'  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.90.zip',
    # 'localizer-zebra-100' : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.localization.zebra.100.zip',
    # 'image-zebra'         : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.image.zebra.pkl',
    # 'default'             : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.image.zebra.pkl',
    # None                  : f'{WILDBOOK_IA_MODELS_BASE}/models/classifier.rf.image.zebra.pkl',
}
...
def classify(vector_list, weight_filepath, verbose=VERBOSE_SVM, **kwargs):
    ...
    classify_iter = ut.generate2(
        classify_helper, args_list, nTasks=nTasks, ordered=True, force_serial=True
    )
